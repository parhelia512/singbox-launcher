...
- Перед написанием новой функции проверь существующие утилиты:
  ...
  - `core/logging.go` - для логирования
...
- Используй структурированное логирование, если проект так делает
- Уровни логирования: debug/info/warn/error - следуй принятому стандарту проекта
- Логируй только "события" и ошибки - не спамь избыточными сообщениями
- Используй существующие функции логирования из `core/logging.go`, не создавай новые
