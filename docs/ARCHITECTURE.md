...
> **Примечание:** Проект прошел значительный рефакторинг для улучшения архитектуры и поддержки кода. Подробности изменений можно найти в [репозитории на GitHub](https://github.com/Leadaxe/singbox-launcher).
